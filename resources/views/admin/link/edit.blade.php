                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Titulo de la enlace" value="{{ old('title', $link->title) }}" required>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="link" value="https://afdeveloper.com" id="link"
                                class="form-control @error('link') is-invalid @enderror" placeholder="Titulo de la enlace" value="{{ old('link', $link->link) }}"
                                required>
                            @error('link')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
